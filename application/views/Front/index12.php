...
<!-- Mirrored from templates.envytheme.com/startp/default/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Jul 2020 14:28:13 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
								...
								<li class="nav-item"><a href="#" class="nav-link active">Home <i data-feather="chevron-down"></i></a>
									<ul class="dropdown_menu">
										<li class="nav-item"><a href="#" class="nav-link active">Home One <i data-feather="chevron-right"></i></a>
											<ul class="dropdown_menu">
												<li class="nav-item"><a href="index-2.html" class="nav-link active">Light Green</a></li>
										...
										<li class="nav-item"><a href="#" class="nav-link">Home Three <i data-feather="chevron-right"></i></a>
											<ul class="dropdown_menu">
												<li class="nav-item"><a href="index-4.html" class="nav-link">Light Green</a></li>
...
<!-- Mirrored from templates.envytheme.com/startp/default/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Jul 2020 14:29:08 GMT -->
</html>